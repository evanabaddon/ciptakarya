      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item {{ \Route::is('rekap-kegiatan.*') ? 'active' : '' }}">
              <a href="{{ route('rekap-kegiatan.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-spreadsheet"></i>
                <div data-i18n="Basic">Rekap Data</div>
              </a>
            </li>
            <!-- Menu User -->
            ...
            <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                <div class="mb-2 mb-md-0">
                  ...
                  , made with ❤️ by
                  <a href="https://instagram.com/evanhelga" target="_blank" class="footer-link fw-bolder">EvanHelga</a>
                </div>
              </div>
            </footer>
            <!-- / Footer -->
