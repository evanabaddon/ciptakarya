                                    ...
                                    @forelse ($models as $item)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('sub-kegiatan.edit', $item->id) }}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i> Edit</a>
                                                <form action="{{ route('sub-kegiatan.destroy',$item->id) }}" method="POST"
